                    ...
                    <Disclosure>
                        {({ open }) => (
                            <>
                                ...
                                We proudly serve Boca Raton and surrounding communities.
                                </Disclosure.Panel>
                            </>
                        )}
                    </Disclosure>
                ...
                <div className="mx-auto w-full max-w-5xl rounded-2xl bg-white py-8 px-6 mb-5">
                    <Disclosure as="div" className="mt-2">
                        {({ open }) => (
                            <>
                                <Disclosure.Button className="flex w-full justify-between rounded-lg px-4 py-2 text-left text-2xl font-medium">
                                    <span>Are your cleaners insured and background-checked?</span>
                                    <ChevronUpIcon
                                        className={`${open ? 'rotate-180 transform' : ''
                                            } h-5 w-5 text-purple-500`}
                                    />
                                ...
                                <Disclosure.Panel className="px-4 pt-4 pb-2 text-base text-black font-normal opacity-50">
                                Yes, all our team members are fully vetted and insured for your peace of mind.
                                </Disclosure.Panel>
                            </>
                        )}
                    </Disclosure>
                    ...
                    <Disclosure as="div" className="mt-2">
                        {({ open }) => (
                            <>
                                ...
                                <Disclosure.Panel className="px-4 pt-4 pb-2 text-base text-black font-normal opacity-50">
                                We use eco-friendly, non-toxic products that are safe for your family and pets while effectively cleaning your space.
                                </Disclosure.Panel>
                            </>
                        )}
                    </Disclosure>
